...
public abstract class ConfirmPopup<V extends View> extends BasicPopup<View> {
    ...
    protected int topLineHeightPixels = 2;//px
    protected int topBackgroundColor = Color.WHITE;
    protected int topHeight = 159;//dp
    ...
    protected CharSequence btn1Text = "";
    protected CharSequence btn2Text = "";
    ...
    protected TextView cancelButton, submitButton, btn1, btn2;
    ...
    protected View makeHeaderView() {
        ...
        int colorBlack = Color.parseColor("#313131");
        float size45 = 45 * mScale;
//==============================================
        RelativeLayout topButtonLayout = new RelativeLayout(activity);
        int height = (int) (topHeight * mScale);
...
//        int padding = ConvertUtils.toPx(activity, topPadding);
        cancelButton.setPadding((int) size45, 0, (int) size45, 0);
        if (!TextUtils.isEmpty(cancelText)) {
            cancelButton.setText(cancelText);
        }
//        cancelButton.setTextColor(ConvertUtils.toColorStateList(cancelTextColor, pressedTextColor));
        cancelButton.setTextColor(colorBlack);
        cancelButton.setTextSize(TypedValue.COMPLEX_UNIT_PX, size45);
        if (cancelTextSize != 0) {
...
//==============================================
        ...
        submitButton.setPadding((int) size45, 0, (int) size45, 0);
        if (!TextUtils.isEmpty(submitText)) {
            submitButton.setText(submitText);
        }
//        submitButton.setTextColor(ConvertUtils.toColorStateList(submitTextColor, pressedTextColor));
        submitButton.setTextColor(colorBlack);
        submitButton.setTextSize(TypedValue.COMPLEX_UNIT_PX, size45);
        if (submitTextSize != 0) {
        ...
        submitButton.setId(R.id.btn_confirm);
        topButtonLayout.addView(submitButton);
//==============================================
        btn1 = new TextView(activity);
        RelativeLayout.LayoutParams params1 = new RelativeLayout.LayoutParams(WRAP_CONTENT, MATCH_PARENT);
        params1.addRule(RelativeLayout.LEFT_OF, R.id.btn_confirm);
        ...
        btn1.setPadding((int) size45, 0, (int) size45, 0);
        btn1.setTextColor(colorBlack);
        btn1.setTextSize(TypedValue.COMPLEX_UNIT_PX, size45);
        btn1.setId(R.id.btn_test1);
        if (text1 != null) btn1.setText(text1);
        if (listener1 != null) btn1.setOnClickListener(listener1);
//        if (!TextUtils.isEmpty(submitText)) {
//            btn1.setText(submitText);
//        }
//        btn1.setTextColor(ConvertUtils.toColorStateList(submitTextColor, pressedTextColor));
//        if (submitTextSize != 0) {
//            btn1.setTextSize(submitTextSize);
//        }
...
//            }
//        });
        topButtonLayout.addView(btn1);
//==============================================
        btn2 = new TextView(activity);
        RelativeLayout.LayoutParams params2 = new RelativeLayout.LayoutParams(WRAP_CONTENT, MATCH_PARENT);
        params2.addRule(RelativeLayout.LEFT_OF, R.id.btn_test1);
        ...
        btn2.setPadding((int) size45, 0, (int) size45, 0);
        btn2.setTextColor(colorBlack);
        btn2.setTextSize(TypedValue.COMPLEX_UNIT_PX, size45);
        if (text2 != null) btn2.setText(text2);
        if (listener2 != null) btn2.setOnClickListener(listener2);
//        if (!TextUtils.isEmpty(submitText)) {
//            btn2.setText(submitText);
//        }
//        btn2.setTextColor(ConvertUtils.toColorStateList(submitTextColor, pressedTextColor));
//        if (submitTextSize != 0) {
//            btn2.setTextSize(submitTextSize);
//        }
...
//        });
    ...
    public void setupBtn1(String text, View.OnClickListener listener) {
        text1 = text;
        listener1 = listener;
//        btn1.setText(text);
//        btn1.setOnClickListener(listener);
    ...
    public void setupBtn2(String text, View.OnClickListener listener) {
        text2 = text;
        listener2 = listener;
//        btn2.setText(text);
