...
//    private static final String TAG = "WheelView";
    ...
    public static final int TEXT_SIZE = 17;//单位为sp
    public static final int TEXT_COLOR_FOCUS = 0XFF467cfd;
    public static final int TEXT_COLOR_NORMAL = 0XFF969696;
    public static final int DIVIDER_COLOR = 0XFF467cfd;
    ...
    private static final float ITEM_PADDING = 15f;//单位为px,480X800的手机边距不能太大
    ...
    private static final float SCALE_CONTENT = 1F;//非中间文字用此控制高度，压扁形成3D错觉,0.1~1.0f
    ...
    private float centerContentOffset = 15;//偏移量
...
//        }
        ...
        centerContentOffset *= mScale;
//        Log.e(TAG, "centerContentOffset:" + centerContentOffset);
        judgeLineSpace();
        initView(context);
    }
    ...
    private void measureTextWidthHeight() {
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            maxTextHeight = (int) (rect.height() + centerContentOffset * 2);
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (dividerConfig.visible) {
            ...
            float startX = measuredWidth * ratio;
//            Log.e(TAG, "startX:" + startX);

            float stopX = measuredWidth * (1 - ratio);
//            Log.e(TAG, "stopX:" + stopX);

            canvas.drawLine(startX, firstLineY, stopX, firstLineY, paintIndicator);
            canvas.drawLine(startX, secondLineY, stopX, secondLineY, paintIndicator);
        }
