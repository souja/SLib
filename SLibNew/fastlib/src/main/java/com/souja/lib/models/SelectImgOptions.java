...
public class SelectImgOptions {
    ...
    public ArrayList<OImageBase> selectedImgListPathB;//已选图片路径列表
    ...
    public SelectImgOptions setMax(int max) {
        this.max = max;
        return this;
    }
    ...
    public SelectImgOptions setSelectedB(ArrayList<OImageBase> selected) {
        this.selectedImgListPathB = selected;
        return this;
    }
