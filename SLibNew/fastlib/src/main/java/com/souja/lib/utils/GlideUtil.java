...
public class GlideUtil {
    ...
    public static void load(FragmentActivity context, File file, int placeHolder, ImageView target) {
    ...
    public static<T extends OImageBase> void showPopImgs44(Context context, View v, List<T> list, int index) {
        ArrayList<ZoomImageModel> zoomImageArrayList = new ArrayList<>();
        for (int i = 0; i < list.size(); i++) {
            OImageBase model = list.get(i);
