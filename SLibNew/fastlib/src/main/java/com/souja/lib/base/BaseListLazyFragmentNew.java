 ...
 */
public abstract class BaseListLazyFragmentNew<T> extends BaseLazyFragmentNew implements IListPage<T> {
    ...
    public int pageIndex = 1, pageAmount = 1, totalCount = 0;
    ...
    public void initPage() {
        ButterKnife.bind(this, _contentView);
