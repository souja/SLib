package com.souja.lib.widget.picker;
...
public abstract class ConfirmPopup<V extends View> extends BasicPopup<View> {
    protected boolean topLineVisible = false;
...
//        if (cancelTextSize != 0) {
        cancelButton.setTextSize(TypedValue.COMPLEX_UNIT_PX, 45 * ScreenUtil.mScale);
//        }
...
//        if (submitTextSize != 0) {
        submitButton.setTextSize(TypedValue.COMPLEX_UNIT_PX, 45 * ScreenUtil.mScale);
//        }
