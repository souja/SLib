...
public class HttpRequest extends UriRequest {
    ...
    protected String buildQueryUrl(RequestParams params) {
        ...
        if (queryParams != null) {
            for (KeyValue kv : queryParams) {
                ...
                if (!MTool.isEmpty(name) && value != null) {
                    queryBuilder.append(
    ...
    public void sendRequest() throws Throwable {
        ...
        {// add headers
            ...
            if (headers != null) {
                for (RequestParams.Header header : headers) {
                    ...
                    if (!MTool.isEmpty(name) && !MTool.isEmpty(value)) {
                        if (header.setHeader) {
        ...
        // checkPermissions response code
