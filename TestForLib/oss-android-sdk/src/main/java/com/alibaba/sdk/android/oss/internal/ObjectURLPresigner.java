...
import com.alibaba.sdk.android.oss.common.utils.AliHttpUtil;
...
public class ObjectURLPresigner {
    ...
    public String presignConstrainedURL(GeneratePresignedUrlRequest request) throws ClientException {
        ...
        String queryString = AliHttpUtil.paramToQueryString(params, "utf-8");

        String url = endpoint.getScheme() + "://" + host + "/" + AliHttpUtil.urlEncode(objectKey, OSSConstants.DEFAULT_CHARSET_NAME)
                + "?" + queryString;
    ...
    public String presignPublicURL(String bucketName, String objectKey) {
        ...
        return endpoint.getScheme() + "://" + host + "/" + AliHttpUtil.urlEncode(objectKey, OSSConstants.DEFAULT_CHARSET_NAME);
    }
}
