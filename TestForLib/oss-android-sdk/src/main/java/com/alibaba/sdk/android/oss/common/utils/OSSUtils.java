...
public class OSSUtils {
    ...
    public static void populateCopyObjectHeaders(CopyObjectRequest copyObjectRequest,
        ...
        String copySourceHeader = "/" + copyObjectRequest.getSourceBucketName() + "/"
                + AliHttpUtil.urlEncode(copyObjectRequest.getSourceKey(), OSSConstants.DEFAULT_CHARSET_NAME);
    ...
    public static String paramToQueryString(Map<String, String> params, String charset) {
        ...
        for (Map.Entry<String, String> p : params.entrySet()) {
            ...
            paramString.append(AliHttpUtil.urlEncode(key, charset));
            if (!isEmptyString(value)) {
                paramString.append("=").append(AliHttpUtil.urlEncode(value, charset));
            }
