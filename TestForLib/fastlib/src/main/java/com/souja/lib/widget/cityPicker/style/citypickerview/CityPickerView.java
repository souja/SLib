package com.souja.lib.widget.cityPicker.style.citypickerview;
...
import com.souja.lib.widget.cityPicker.Interface.OnCityItemClickListener;
...
import com.souja.lib.widget.cityPicker.citywheel.CityConfig;
import com.souja.lib.widget.cityPicker.citywheel.CityParseHelper;
import com.souja.lib.widget.cityPicker.style.citypickerview.widget.CanShow;
import com.souja.lib.widget.cityPicker.style.citypickerview.widget.wheel.OnWheelChangedListener;
import com.souja.lib.widget.cityPicker.style.citypickerview.widget.wheel.WheelView;
import com.souja.lib.widget.cityPicker.style.citypickerview.widget.wheel.adapters.ArrayWheelAdapter;
import com.souja.lib.widget.cityPicker.utils.utils;
...
public class CityPickerView implements CanShow, OnWheelChangedListener {
    ...
    private void initCityPickerPopwindow() {
        ...
        if (parseHelper.getProvinceBeanArrayList().isEmpty()) {
            Toast.makeText(context,"请在Activity中增加init操作", Toast.LENGTH_SHORT);
            return;
        }
