package com.souja.lib.widget.cityPicker.style.cityjd;
...
import static com.souja.lib.widget.cityPicker.style.cityjd.JDConst.INDEX_INVALID;
...
public class AreaAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.selectImg = convertView.findViewById(R.id.selectImg);
